...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--ndf', type=int, default=96, help='# of discrim filters in the first conv layer')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='numpy', help='chooses how datasets are loaded. [unaligned | aligned | single | colorization]')
